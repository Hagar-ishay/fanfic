        ...
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col justify-center relative items-center text-center">
            <div className="mb-4">
              <div className="flex items-center justify-center gap-4 mb-3">
                <h1 className="text-2xl md:text-3xl md:leading-normal font-bold tracking-tight bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent ">
            ...
            <p className="text-xs text-muted-foreground mx-auto max-w-2xl mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-6">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="bg-card/80 backdrop-blur-sm border border-border/50 shadow-md hover:shadow-lg transition-all duration-200 hover:scale-[1.02] group"
              >
